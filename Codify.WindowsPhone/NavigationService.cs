...
namespace Codify.WindowsPhone
{
    public class NavigationService : INavigationService
    {
        ...
        public NavigationService(PhoneApplicationFrame phoneApplicationFrame, Func<Type, NotifyableEntity> viewModelFactory)
        {
            ...
            _phoneApplicationFrame.Navigating += OnPhoneApplicationFrameNavigating;
        }
        ...
        private void OnPhoneApplicationFrameNavigating(object sender, NavigatingCancelEventArgs e)
        {
            if (Navigating == null) return;
            var element = (FrameworkElement) _phoneApplicationFrame.Content;
            Navigating(element.DataContext ?? element, e);
        }
